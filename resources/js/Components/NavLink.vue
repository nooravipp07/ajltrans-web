...
const classes = computed(() =>
    props.active
        ? 'inline-flex items-center px-1 pt-1 border-b-2 border-primary text-sm font-bold leading-5 text-slate-900 focus:outline-none focus:border-primary-dark transition duration-150 ease-in-out'
